          ...
          {PILLARS.map((pillar) => {
            ...
            return (
              <motion.div key={pillar.title} variants={cardVariant}>
                <Link
                  href={pillar.href}
                  className="group relative flex flex-col h-full rounded-2xl border border-surface-border bg-surface-elevated/50 p-8 card-hover overflow-hidden conic-border-active-accent"
                >
